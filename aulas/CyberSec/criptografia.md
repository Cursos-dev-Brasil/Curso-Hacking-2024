...
A criptografia funciona como um cano que transporta seus dados de um sistema pra outro(esse foi o pior exemplo possível), pros seus dados entrarem nesse cano, 2 alternativas são muito usadas

### Criptografia assimetrica X simétrica

#### Criptografia Simétrica

Nesse estilo de criptografia o
